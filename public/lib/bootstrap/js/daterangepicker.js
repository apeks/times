                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div style="float: left;">' +
                      '<label for="daterangepicker_start" style="display:inline-block">' + this.locale.fromLabel + '</label>' +
                      '<input class="input" type="text" name="daterangepicker_start" value="" disabled="disabled" />' +
                    '</div>' +
                    '<div style="float: left;x">' +
                      '<label for="daterangepicker_end" style="display:inline-block">' + this.locale.toLabel + '</label>' +
                      '<input class="input" type="text" name="daterangepicker_end" value="" disabled="disabled" />' +
                    '</div>' +
                    '<button class="btn btn-primary" disabled="disabled">' + this.locale.applyLabel + '</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
